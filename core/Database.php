...
//        echo 'hhh';
        //mysqli_select_db:selects database name
         ...
         mysqli_select_db($this->connection, "sql7293366") or die("database selection failed :" . mysqli_error($this->connection));
...
//        $this->close_connection();
    ...
    public function getTotal($table, $rows = '*', $where = null, $group = null) {
        // Create query from the variables passed to the function
        $query = 'SELECT ' . $rows . ' FROM ' . $table;
